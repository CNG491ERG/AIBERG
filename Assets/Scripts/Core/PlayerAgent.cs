...
namespace AIBERG.Core
{
    public class PlayerAgent : Agent
    {
        ...
        [SerializeField] public bool activeAbility1Input;
        [SerializeField] public bool activeAbility2Input;
        ...
        public override void Heuristic(in ActionBuffers actionsOut)
        {
            ...
            {
                basicAttackInput = player.inputHandler.BasicAbilityInput;
                activeAbility1Input = player.inputHandler.ActiveAbility1Input;
                activeAbility2Input = player.inputHandler.ActiveAbility2Input;
